...
const AppContent: React.FC = () => {
  ...
  const checkPermission = useCallback((module: string) => {
    ...
    // 3. Block deactivated (fired) employees from all modules
    if (currentEmployee.status === 'inactive') return false;

    // 4. Check specific module permission
  ...
  return (
    <CurrentEmployeeProvider employee={currentEmployee}>
