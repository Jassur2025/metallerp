...
export const JournalEventsView: React.FC<JournalEventsViewProps> = ({ events }) => {
    ...
    return (
        <div className="h-full overflow-auto p-6 space-y-6 animate-fade-in bg-slate-900">
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-400 text-sm">История действий и изменений в системе</p>
                </div>
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                    ...
                    <select
                        ...
                        className="bg-slate-800 border border-slate-700 rounded-lg text-white text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                ...
                {filteredEvents.length === 0 ? (
                    ...
                    filteredEvents.map((event, index) => (
                        ...
                        >
                            ...
                            <div className="hidden md:block absolute left-[149px] top-8 w-4 h-[2px] bg-slate-700/50"></div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 group">
                                ...
                                {/* Content Card */}
                                <div className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 hover:bg-slate-800 transition-colors">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-slate-700/50 space-y-3 animate-fade-in">
                                            {event.receiptDetails && (
                                                <div className="bg-slate-900/50 rounded-lg p-3 text-sm">
                                                    <p className="text-slate-400 mb-2 font-medium">Детали чека:</p>
                                            ...
                                            {event.metadata && (
                                                <div className="bg-slate-900/50 rounded-lg p-3 text-sm font-mono overflow-x-auto">
